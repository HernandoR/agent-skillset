...
| [RFC-0008](rfc-0008-multi-harness-plugin-compatibility-2026-08-05.md) | Multi-Harness Plugin Compatibility (Codex and Pi) | Resolved → [ADR-0009](../plans/adr-0009-multi-harness-plugin-compatibility-2026-08-05.md) |
